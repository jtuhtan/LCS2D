% gyrefield - creates test double gyre field which can be used to investigate LCS
...
resGridVel = 0.015; % velocity field resolution, same in x and y directions
%note.
...
figure(1);
contourf(gX,gY,velMag), hold on, quiver(gX(1:1:end),gY(1:1:end),u(1:1:end),v(1:1:end)), axis equal, axis tight, 
xlabel('x [m]');
ylabel('y [m]');
